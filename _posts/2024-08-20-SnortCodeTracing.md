...
Here is the [official user manual](https://www.snort.org/documents/snort-users-manual-2-9-16-html) of the snort 2.9.16. Although it mainly focus on how to use it instead of how to develope it, somehow I find it very helpful to obtruse the system operation when first time studying it with no clue at all.
Then, there are dozens of `dev_notes.txt` inside `src/*` directory. I will pick several for example, depending on our needs, and dive in to see where will it lead us to.
...
![GDB break point at main_loop funtion](/assets/img/gdb/gdb_mainloop.png)
...
![main call funtion diagram](/assets/img/diagram/main_main.png)
...
![snort_main call funtion diagram](/assets/img/diagram/main_snortmain.png)
...
![pig_trough and pig_couch](/assets/img/others/trough_and_couch.jpg)
...
```
![pig_collaborator diagram](/assets/img/diagram/classPig_collaborate_graph.png)
